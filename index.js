...
const usuario1 = new UserCommon("Ezio", "Auditore", "EzioCdl", "ezio@example.com", 37, "Rua 34 de Agosto");
const usuario2 = new UserAdmin("Thais", "Silva", "ThaisClx", "thais@example.com", "Rua 24ee, 34", "Gerente Comercial");
